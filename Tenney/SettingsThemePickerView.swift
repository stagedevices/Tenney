        ...
        ThemeSwatch(theme: theme)
            ...
            .overlay(
                RoundedRectangle(cornerRadius: 14, style: .continuous)
                    .stroke(isSelected ? Color.accentColor.opacity(0.8) : Color.secondary.opacity(0.15), lineWidth: isSelected ? 2 : 1)
...
private var symbol: some View {
    ...
    let gradient = LinearGradient(colors: [.pink, .orange, .yellow, .green, .cyan, .blue, .purple], startPoint: .topLeading, endPoint: .bottomTrailing)
    ...
    VStack(alignment: .leading, spacing: 8) {
        ZStack(alignment: .topTrailing) {
            RoundedRectangle(cornerRadius: 14, style: .continuous)
                ...
                .overlay(
                    RoundedRectangle(cornerRadius: 14, style: .continuous)
                        .stroke(isSelected ? Color.accentColor.opacity(0.85) : Color.secondary.opacity(0.15), lineWidth: isSelected ? 2 : 1)
                )
                .overlay(
                    symbol
                        .padding(16)
