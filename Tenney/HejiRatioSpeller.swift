...
func pythagoreanBaseE3Interval(for ratio: Ratio, octave: Int = 0, maxPrime: Int = 13) -> Int {
    ...
    if let monzo = ratio.toMonzoIfWithin13() {
        ...
        e7 = maxPrime >= 7 ? (vFactor(7, ratio.n) - vFactor(7, ratio.d)) : 0
        e11 = maxPrime >= 11 ? (vFactor(11, ratio.n) - vFactor(11, ratio.d)) : 0
        e13 = maxPrime >= 13 ? (vFactor(13, ratio.n) - vFactor(13, ratio.d)) : 0
    }
