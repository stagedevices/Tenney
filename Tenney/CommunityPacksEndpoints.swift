...
enum CommunityPacksEndpoints {
    ...
    static let submitURL = URL(string: "https://github.com/stagedevices/tenney-scales/issues/new?template=pack_submission.yml")!
    static let issuesURL = URL(string: "https://tenneyapp.com/community")!
